...
export const createAnimeDetailStyles = (theme: MD3Theme, screenDimensions: ScreenDimensions) => {
  return StyleSheet.create({
    ...
    headerContainer: {
      ...
      paddingTop: 40,
      paddingRight: screenDimensions.headerPadding,
      minHeight: screenDimensions.headerMinHeight,
      position: 'relative',
    ...
    infoContainer: {
      ...
      marginRight: screenDimensions.isSmallPhone ? 0 : screenDimensions.headerPadding,
      paddingRight: screenDimensions.isSmallPhone ? screenDimensions.headerPadding : 0,
